...
- Accuracy is more important than speed. Read the full question and every option, confirm each interaction, and perform a complete final review.
...
- Leave the completed or reviewed form open for the user and finish with a Markdown summary table of answers, evidence or reasoning, confidence or status, and unresolved items. State explicitly that nothing was submitted.
